...
{ 
    ...
    public class SessionSpecificationBuilder
    {
        ...
        private List<RequiredDocument> _requiredShareCodes;
        ...
        /// <summary>
        /// Sets the <see cref="RequiredShareCode"/>
        /// </summary>
        /// <param name="requiredShareCode">The <see cref="RequiredShareCode"/></param>
        /// <returns>the builder</returns>
        public SessionSpecificationBuilder WithRequiredShareCode(RequiredDocument requiredShareCode)
        {
            if (_requiredShareCodes == null)
                _requiredShareCodes = new List<RequiredDocument>();
