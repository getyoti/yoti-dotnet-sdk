...
namespace Yoti.Auth.DocScan.Session.Create
{
    public class SdkConfigBuilder
    {
        ...
        /// <summary>
        /// Sets the list of screens to suppress from the IDV flow. Each value must be one of the
        /// <c>SuppressedScreen*</c> constants defined on <see cref="DocScanConstants"/>.
        /// </summary>
        /// <param name="suppressedScreens">The screens to suppress</param>
        /// <returns>The <see cref="SdkConfigBuilder"/></returns>
        ...
        /// </summary>
        /// <param name="suppressedScreen">The screen identifier to suppress (see <c>SuppressedScreen*</c> constants on <see cref="DocScanConstants"/>)</param>
        /// <returns>The <see cref="SdkConfigBuilder"/></returns>
