...
namespace Yoti.Auth.DocScan.Session.Create.Check.Advanced
{
    public class RequestedWatchlistAdvancedCaConfigYotiAccount : RequestedWatchlistAdvancedCaConfig
    {
        ...
        [JsonConstructor]
        public RequestedWatchlistAdvancedCaConfigYotiAccount(bool removeDeceased, bool shareUrl, RequestedCaSources sources, RequestedCaMatchingStrategy matchingStrategy, int? handledCheckLimit)
