...
namespace Yoti.Auth.DocScan.Session.Create
{
    public class SessionSpecification
    {
        ...
        public List<RequiredDocument> RequiredShareCodes { get; }
    }
}
